package com.itsoku.lesson032.mq;

import com.itsoku.lesson032.lock.DistributeLock;
import com.itsoku.lesson032.mq.delay.DelayTaskProcessor;
import com.itsoku.lesson032.mq.mapper.MsgMapper;
import com.itsoku.lesson032.mq.properties.MqProperties;
import com.itsoku.lesson032.mq.retry.DefaultMqSendRetry;
import com.itsoku.lesson032.mq.retry.MqSendRetry;
import com.itsoku.lesson032.mq.sender.DefaultMsgSender;
import com.itsoku.lesson032.mq.sender.IMsgSender;
import com.itsoku.lesson032.mq.sender.MqSendRetryJob;
import com.itsoku.lesson032.mq.service.IMsgService;
import com.itsoku.lesson032.mq.service.MsgServiceImpl;
...
public class MqConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public IMsgSender msgSender(IMsgService msgService, MqSendRetry mqSendRetry, DistributeLock distributeLock) {
        return new DefaultMsgSender(msgService, mqSendRetry, this.mqExecutor(), this.delayMsgProcessor(), this.delaySendRetryProcessor(), distributeLock);
    }
