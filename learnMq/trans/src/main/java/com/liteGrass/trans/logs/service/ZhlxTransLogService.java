package com.liteGrass.trans.logs.service;
...
/**
 * @ClassName ZhlxTransLogService
 * @Company Huahui Information Technology Co., LTD.
 * @Author liteGrass
 * @Date 2025/4/24 22:38
 * @Description
 */
public interface ZhlxTransLogService extends IService<ZhlxTransLogEntity> {
    void saveLog(ZhlxTransLogEntity transLog);

    void updateTransStatus(String transId, String transStatus);

    String getTransStatus(String transId);
}
