...
/**
 * @ClassName TransMessageDelegate
 * @Company Huahui Information Technology Co., LTD.
 * @Author liteGrass
 * @Date 2025/4/24 16:23
 * @Description
 */
public abstract class TransMessageAdvisor {
    ...
    public abstract Object wrapWithTransaction(ProceedingJoinPoint joinPoint, ZhlxTransactionalMessage txMsg);
